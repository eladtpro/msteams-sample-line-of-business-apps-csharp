...
namespace Airline.PassengerInfo.Web
{
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            DocumentDBRepository.Initialize(); // Initialize DB
            Conversation.UpdateContainer(
               builder =>
               {
                   ...
                   //var store = new DocumentDbBotDataStore(DocumentDBRepository.Client); // requires Microsoft.BotBuilder.Azure Nuget package 
